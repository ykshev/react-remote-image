...
var RemoteImage = function (_Component) {
  ...
  function RemoteImage(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (RemoteImage.__proto__ || Object.getPrototypeOf(RemoteImage)).call(this, props, context));
  ...
  _createClass(RemoteImage, [{
    ...
    value: function render() {
      ...
      var renderLoading = props.renderLoading,
          renderFetched = props.renderFetched,
          renderFailure = props.renderFailure,
          renderProps = _objectWithoutProperties(props, ['renderLoading', 'renderFetched', 'renderFailure']);
